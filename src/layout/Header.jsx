    ...
    return (
        ...
        <div className='flex justify-center items-center gap-8 relative'>
          ...
          <span className='text-[14px] w-full font-normal'>{ userInfo.role }</span>
              ...
              {
                userInfo.role === 'admin' ? <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src="%PUBLIC URL%/images/admin.jpg" alt="" />  : <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src={userInfo.image} alt="" />
              }
