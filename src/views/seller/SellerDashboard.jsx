                ...
                <div className='lg:col-span-5'>
                    <div className='bg-white rounded-xl sm:rounded-2xl p-3 sm:p-6 shadow-sm border border-gray-100 h-full'>
                        <div className='flex justify-between items-center mb-3 sm:mb-4'>
                            <h2 className='text-base sm:text-lg font-bold text-gray-800'>Recent Messages</h2>
                            <Link to='/seller/dashboard/chat-customer' className='text-xs sm:text-sm text-cyan-600 hover:text-cyan-700 font-medium'>View All</Link>
                        </div>
            ...
            <div className='mt-4 sm:mt-6'>
                <div className='bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden'>
                    <div className='px-3 sm:px-6 py-3 sm:py-4 border-b border-gray-100 flex justify-between items-center'>
                        ...
                        <Link to='/seller/dashboard/orders' className='text-xs sm:text-sm text-cyan-600 hover:text-cyan-700 font-medium'>View All</Link>
                    </div>
