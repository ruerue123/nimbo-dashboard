                ...
                <div className='lg:col-span-5'>
                    <div className='bg-white rounded-2xl p-6 shadow-sm border border-gray-100 h-full'>
                        <div className='flex justify-between items-center mb-4'>
                            <h2 className='text-lg font-bold text-gray-800'>Seller Messages</h2>
                            <Link to='/admin/dashboard/chat-sellers' className='text-sm text-cyan-600 hover:text-cyan-700 font-medium'>View All</Link>
                        </div>
            ...
            <div className='mt-6'>
                <div className='bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden'>
                    <div className='px-6 py-4 border-b border-gray-100 flex justify-between items-center'>
                        ...
                        <Link to='/admin/dashboard/orders' className='text-sm text-cyan-600 hover:text-cyan-700 font-medium'>View All</Link>
                    </div>
